    ...
    if (!is_wp_error($attach_id)) {
        ...
        <head>
            <style>
                ...
                .header { background-color: #047051; color: white; padding: 20px; text-align: center; }
                .content { padding: 20px; background-color: #f9f9f9; }
                .button { display: inline-block; padding: 12px 24px; background-color: #047051; color: white; text-decoration: none; border-radius: 4px; margin: 20px 0; }
            ...
            <div class='container'>
                ...
                <div class='content'>
                    ...
                    <p style='text-align: center;'>
                        <a href='" . esc_url($file_url) . "' class='button'>View Your Wellness Plan</a>
                    </p>
                    <p>If the button doesn't work, you can copy and paste this link into your browser:</p>
                    <p style='word-break: break-all;'>" . esc_url($file_url) . "</p>
        ...
        if ($mail_sent) {
            ...
            echo json_encode([
                ...
                'attachment_id' => $attach_id,
                'email_sent' => false,
                'message' => 'PDF uploaded successfully but email could not be sent'
            ]);
        }
    } else {
